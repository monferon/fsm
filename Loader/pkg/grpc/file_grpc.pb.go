...
type SenderClient interface {
	// Sends a greeting
	Send(ctx context.Context, in *Chunk, opts ...grpc.CallOption) (*UploadStatus, error)
}
...
func (c *senderClient) Send(ctx context.Context, in *Chunk, opts ...grpc.CallOption) (*UploadStatus, error) {
	out := new(UploadStatus)
	err := c.cc.Invoke(ctx, "/file.Sender/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SenderServer interface {
	// Sends a greeting
	Send(context.Context, *Chunk) (*UploadStatus, error)
...
func (UnimplementedSenderServer) Send(context.Context, *Chunk) (*UploadStatus, error) {
...
func _Sender_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/file.Sender/Send",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SenderServer).Send(ctx, req.(*Chunk))
	}
